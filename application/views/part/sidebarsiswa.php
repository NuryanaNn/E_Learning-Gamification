...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!--    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('siswa/jadwalMapel/1'); ?>">
  ...
  <!-- <li class="nav-item">
        <a class="nav-link" href="<?= base_url('siswa/filtersiswa'); ?>">
          <i class="fas fa-users"></i>
          <span>Filter Siswa</span></a>
      </li> -->
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('siswa/leaderboard'); ?>">
      <i class="fas fa-trophy"></i>
