                ...
                <div class="mx-auto d-block">
                    ...
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                        <form action="<?=base_url()?>admin/filterPengajar" enctype="multipart/form-data" method="post">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url()?>admin/detailFilterPengajar/<?=$key->id?>" class="btn btn-primary">Detail</a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
