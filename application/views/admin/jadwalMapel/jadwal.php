    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="map-data m-b-40">
                <h3 class="title-3 m-b-30">Jadwal Pelajaran Kelas</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>admin/tambahJamMengajar/<?=$k->id?>/<?=$k->kelas_id?>/<?= $k->mapel_id?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i></a></td>
                                    </tr>
                                    <?php } }?>
                                    </tbody>
                                </table>
