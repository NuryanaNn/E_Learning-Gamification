                    ...
                    <div class="container-fluid">
                        <?php foreach ($data as $key) { ?>
                            <div class="card card-body">
                                <h5><?= $key->nama ?></h5>
                                <hr>
                                <a href="<?= base_url() ?>admin/aturMapelKelas/<?= $key->id ?>" class="btn btn-primary pull-right">Atur Mata Pelajaran</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="<?= base_url() ?>admin/hapusMapelKelas/<?= $k->id ?>" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a></td>
                                                    </tr>
                                            <?php }
                                            } ?>
                                        </tbody>
