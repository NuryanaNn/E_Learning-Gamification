                ...
                <div class="mx-auto d-block">
                    ...
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                        <form action="<?=base_url()?>admin/filterSiswa" enctype="multipart/form-data" method="post">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url()?>admin/detailFilterSiswa/<?=$key->siswa_id?>" class="btn btn-primary btn-circle"><i class="fas fa-info-circle"></i></a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
