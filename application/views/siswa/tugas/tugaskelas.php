        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <p>Kerjakanlah Tugas Anda Dan Dapatkan Skor Terbaik</p>
                </div>
            </div>
            <!-- MAP DATA-->
                                                ...
                                                <?php foreach ($mapel as $k) {
                                                    if ($key->id == $k->kelas_id) { ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?= base_url() ?>siswa/listTugas/<?= $k->kelas_id ?>/<?= $k->mapel_id ?>" class="btn btn-success btn-circle"><i class="fas fa-eye"></i></a></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
