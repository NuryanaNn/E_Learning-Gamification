        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <p>Perbanyak Membaca Untuk Menyelesaikan tugas Anda</p>
                </div>
            </div>
            <!-- MAP DATA-->
                                                ...
                                                <?php foreach ($mapel as $k) {
                                                    if ($key->id == $k->kelas_id) { ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?= base_url() ?>siswa/listMateri/<?= $k->kelas_id ?>/<?= $k->mapel_id ?>" class="btn btn-success btn-circle"><i class="fas fa-eye"></i></a></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
