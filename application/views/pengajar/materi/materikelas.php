        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <p class="text-center">Berikan Materi Kepada Siswa Anda</p>
                </div>
            </div>
            <!-- MAP DATA-->
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($k->mapel_id == $pengajar[0]->id_mapel) { ?>
                                                            <td><a href="<?= base_url() ?>pengajar/listMateri/<?= $k->kelas_id ?>/<?= $k->mapel_id ?>" class="btn btn-success btn-circle"><i class="fas fa-eye"></i></a></td>
                                                        <?php } else { ?>
                                                            <td></td>
                                                        <?php } ?>
                                                    </tr>
